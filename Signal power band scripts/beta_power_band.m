...
% for i = 1:10
%     figure()
%     boxplot([ratio_RestFirst(:, i) ratio_RestLast(:, i)])
%     title('Median laterality of First and Last 5 Rest Sessions, beta band')
%     set(gca, 'XTickLabel', {'Early', 'Late'})
% end
% for i = 1:10
%     figure()
%     boxplot([ratio_MoveFirst_beta(:, i) ratio_MoveLast_beta(:, i)])
%     title('Median laterality of First and Last 5 Move Sessions, beta band')
%     set(gca, 'XTickLabel', {'Early', 'Late'})
% end