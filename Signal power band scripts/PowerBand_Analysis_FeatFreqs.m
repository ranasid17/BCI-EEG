...
for i = 1:10
    ...
    centDist_ft_ipsi(i) = centDist_alpha_temp_ipsi(2, i) - centDist_alpha_temp_ipsi(1, i);
...
for i = 1:10
    ...
    %%Calc change from FIRST to LAST 5 sessions
    centDist_ft_contra(i) = centDist_alpha_temp_contra(2, i) - centDist_alpha_temp_contra(1, i);
