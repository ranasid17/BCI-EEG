...
ratio_RestFirst_delta= zeros(150,10);
ratio_RestLast_delta = zeros(150,10);
ratio_MoveFirst_delta = zeros(150, 10);
ratio_MoveLast_delta = zeros(150, 10);
...
for i = 1:10
    ...
    ratio_RestFirst_delta(:, i) = ratio_RestFirst_ContraIpsi(1, :);
    ratio_RestLast_delta(:, i) = ratio_RestLast_ContraIpsi(1, :);
    ratio_MoveFirst_delta(:, i) = ratio_MoveFirst_ContraIpsi(1, :);
    ratio_MoveLast_delta(:, i) = ratio_MoveLast_ContraIpsi(1, :);
end
%% Calc difference in early - late medians
ratio_RestDifference_delta= ratio_RestLast_delta - ratio_RestFirst_delta;
ratio_MoveDifference_delta = ratio_MoveLast_delta - ratio_MoveFirst_delta;
