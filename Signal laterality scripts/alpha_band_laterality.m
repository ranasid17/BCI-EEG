...
ratio_RestFirst_alpha= zeros(150,10);
ratio_RestLast_alpha = zeros(150,10);
ratio_MoveFirst_alpha = zeros(150, 10);
ratio_MoveLast_alpha = zeros(150, 10);
...
for i = 1:10
    ...
    ratio_RestFirst_alpha(:, i) = ratio_RestFirst_ContraIpsi(1, :);
    ratio_RestLast_alpha(:, i) = ratio_RestLast_ContraIpsi(1, :);
    ratio_MoveFirst_alpha(:, i) = ratio_MoveFirst_ContraIpsi(1, :);
    ratio_MoveLast_alpha(:, i) = ratio_MoveLast_ContraIpsi(1, :);
end
